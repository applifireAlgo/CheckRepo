Ext.define('Mobproj.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Mobproj.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Mobproj.view.console.ConsoleWindow');
