package mobproj.app.server.repository.organizationboundedcontext.location.aspect;
import mobproj.app.server.repository.aspect.RepositoryAspect;
...
public class RepositorylocationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.organizationboundedcontext.location..*(..))")
