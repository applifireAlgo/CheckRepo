...
public class TimezoneRepositoryImpl extends SearchInterfaceImpl implements TimezoneRepository<Timezone> {
    ...
    public List<Timezone> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<mobproj.app.shared.organizationboundedcontext.location.Timezone> query = emanager.createQuery("select u from Timezone u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Timezone> save(List<Timezone> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                mobproj.app.shared.organizationboundedcontext.location.Timezone obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            mobproj.app.shared.organizationboundedcontext.location.Timezone s = emanager.find(mobproj.app.shared.organizationboundedcontext.location.Timezone.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Timezone findById(String timeZoneId) throws Exception, SpartanPersistenceException {
        try {
            ...
            mobproj.app.shared.organizationboundedcontext.location.Timezone listOfTimezone = (mobproj.app.shared.organizationboundedcontext.location.Timezone) query.getSingleResult();
