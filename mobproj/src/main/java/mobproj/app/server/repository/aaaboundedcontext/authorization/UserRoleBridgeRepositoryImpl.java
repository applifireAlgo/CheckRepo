...
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public List<UserRoleBridge> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge> query = emanager.createQuery("select u from UserRoleBridge u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<UserRoleBridge> save(List<UserRoleBridge> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge s = emanager.find(mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
    ...
    public UserRoleBridge findById(String roleUserMapId) throws Exception, SpartanPersistenceException {
        try {
            ...
            mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge listOfUserRoleBridge = (mobproj.app.shared.aaaboundedcontext.authorization.UserRoleBridge) query.getSingleResult();
            return listOfUserRoleBridge;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
