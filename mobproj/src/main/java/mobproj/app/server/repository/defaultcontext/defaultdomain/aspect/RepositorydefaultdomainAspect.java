package mobproj.app.server.repository.defaultcontext.defaultdomain.aspect;
...
public class RepositorydefaultdomainAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.repository.defaultcontext.defaultdomain..*(..))")
