package mobproj.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
