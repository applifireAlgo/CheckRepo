package mobproj.app.server.businessservice.organizationboundedcontext.location.aspect;
import mobproj.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.businessservice.organizationboundedcontext.location..*(..))")
