package mobproj.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
