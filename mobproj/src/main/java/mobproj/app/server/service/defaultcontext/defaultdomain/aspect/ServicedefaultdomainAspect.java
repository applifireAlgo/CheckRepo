package mobproj.app.server.service.defaultcontext.defaultdomain.aspect;
...
public class ServicedefaultdomainAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.defaultcontext.defaultdomain..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
