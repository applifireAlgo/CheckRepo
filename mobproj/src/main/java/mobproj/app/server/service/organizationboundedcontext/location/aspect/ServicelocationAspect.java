package mobproj.app.server.service.organizationboundedcontext.location.aspect;
import mobproj.app.server.service.aspect.ServiceAspect;
...
public class ServicelocationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* mobproj.app.server.service.organizationboundedcontext.location..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
