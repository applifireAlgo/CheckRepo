...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            mobproj.app.shared.organizationboundedcontext.contacts.CommunicationData other = (mobproj.app.shared.organizationboundedcontext.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
