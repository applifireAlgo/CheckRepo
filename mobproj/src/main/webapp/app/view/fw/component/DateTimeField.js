 ...
 */
Ext.define('Mobproj.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Mobproj.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Mobproj.view.fw.component.DateTimePicker(o);
    },
