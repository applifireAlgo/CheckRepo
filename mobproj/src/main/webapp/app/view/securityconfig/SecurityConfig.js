 ...
 * 
 */
Ext.define('Mobproj.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mobproj.view.securityconfig.SecurityConfigController',
			'Mobproj.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
