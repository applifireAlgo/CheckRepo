Ext.define('Mobproj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mobproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobproj.model.AddUserDataModel' ],
