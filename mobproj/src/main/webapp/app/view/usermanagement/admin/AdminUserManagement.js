Ext.define('Mobproj.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Mobproj.view.usermanagement.admin.UserPasswordReset',
	            'Mobproj.view.usermanagement.admin.AddUserDetails',
	            'Mobproj.view.usermanagement.admin.ViewUser'],
