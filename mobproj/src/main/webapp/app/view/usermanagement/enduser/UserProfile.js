Ext.define('Mobproj.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Mobproj.view.usermanagement.enduser.UserProfileController', 'Mobproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobproj.model.AddUserDataModel' ],
