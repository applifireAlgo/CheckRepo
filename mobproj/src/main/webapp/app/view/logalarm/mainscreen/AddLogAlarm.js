 ...
 * 
 */
Ext.define('Mobproj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mobproj.view.logalarm.mainscreen.AddLogAlarmController',
			'Mobproj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mobproj.view.logalarm.mainscreen.AppAlarmPanel',
