Ext.define("Mobproj.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Mobproj.view.clouddrive.CloudDriveController',
	             'Mobproj.view.clouddrive.documentview.DocumentsView',
	             'Mobproj.view.clouddrive.drivedetails.DriveDetails',
	             //'Mobproj.view.clouddrive.documentview.DocumentListView'
	             ],
