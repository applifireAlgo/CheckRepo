Ext
		.define(
				'Mobproj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mobproj.view.searchengine.search.SearchEngineMainPanelController','Mobproj.view.searchengine.search.PanelHeaderField' ,'Mobproj.view.searchengine.search.ReportGridView','Mobproj.view.searchengine.search.ReportChartView','Mobproj.view.searchengine.search.documentView','Mobproj.view.searchengine.search.DouMeanView','Mobproj.view.googlemaps.map.MapPanel'],
