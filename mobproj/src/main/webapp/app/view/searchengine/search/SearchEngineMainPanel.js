Ext.define('Mobproj.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Mobproj.view.searchengine.search.NorthPanel', 'Mobproj.view.searchengine.search.SearchResult','Mobproj.view.searchengine.search.SearchEngineMainPanelController'],
