...
Ext
		.define(
				'Mobproj.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Mobproj.view.logger.tabs.details.DetailsTab',
							'Mobproj.view.logger.tabs.fileconnector.FileConnectorTab',
							'Mobproj.view.logger.tabs.dbconnector.DBConnectorTab',
							'Mobproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Mobproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Mobproj.view.logger.LogConfigurationTabPanelController',
