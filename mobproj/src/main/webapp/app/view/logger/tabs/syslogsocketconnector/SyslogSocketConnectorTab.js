 ...
 * 
 */
Ext.define('Mobproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Mobproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
