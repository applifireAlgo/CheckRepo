 ...
 */
Ext.define('Mobproj.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Mobproj.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Mobproj.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Mobproj.view.login.SessionLogin').center();
